...
setup(
    ...
    url = 'https://github.com/shehrozkapoor/PDFEXTRACTOR.git',
    ...
    project_urls={
        'Documentation': 'https://python-PDFEXTRACTOR.readthedocs.io/',
        'Changelog': 'https://python-PDFEXTRACTOR.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://https://github.com/shehrozkapoor/PDFEXTRACTOR.git/shehrozkapoor/python-PDFEXTRACTOR/issues',
    },
    keywords=[
